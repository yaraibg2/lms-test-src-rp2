...
public class Case14 {
	...
	void test01() throws Exception {
		...
		FileUtils.copyFile(file,
				new File(
						"evidence/case14/01_loginPage.png"));
	}
	...
	void test02() throws Exception {
		...
		FileUtils.copyFile(file,
				new File(
						"evidence/case14/02_success.png"));
	}
	...
	void test03() throws Exception {
		...
		FileUtils.copyFile(file,
				new File(
						"evidence/case14/03_section.png"));
	}
	...
	void test04() throws Exception {
		...
		FileUtils.copyFile(file,
				new File(
						"evidence/case14/04_examDetail.png"));
	}
	...
	void test05() throws Exception {
		...
		FileUtils.copyFile(file,
				new File(
						"evidence/case14/05_examStart.png"));
	}
	...
	void test06() throws Exception {
		...
		WebElement main = webDriver.findElement(By.id("main"));
		final List<WebElement> questions = main.findElements(By.tagName("ul"));
		questions.get(0).findElements(By.tagName("label")).get(2).click();
		scrollBy("450");
		questions.get(1).findElements(By.tagName("label")).get(2).click();
		scrollBy("350");
		questions.get(2).findElements(By.tagName("label")).get(2).click();
		scrollBy("350");
		questions.get(3).findElements(By.tagName("label")).get(3).click();
		scrollBy("350");
		questions.get(4).findElements(By.tagName("label")).get(1).click();
		scrollBy("350");
		questions.get(5).findElements(By.tagName("label")).get(1).click();
		scrollBy("350");
		questions.get(6).findElements(By.tagName("label")).get(2).click();
		scrollBy("400");
		questions.get(7).findElements(By.tagName("label")).get(3).click();
		scrollBy("400");
		questions.get(8).findElements(By.tagName("label")).get(2).click();
		scrollBy("400");
		questions.get(9).findElements(By.tagName("label")).get(1).click();
		scrollBy("400");
		questions.get(10).findElements(By.tagName("label")).get(1).click();
		scrollBy("350");
		questions.get(11).findElements(By.tagName("label")).get(1).click();
		scrollBy("1000");
		...
		FileUtils.copyFile(file,
				new File(
						"evidence/case14/06_examCheck.png"));
	}
	...
	void test07() throws InterruptedException, IOException {
		...
		FileUtils.copyFile(file,
				new File(
						"evidence/case14/07_examResult.png"));
	}
	...
	void test08() throws Exception {
		...
		assertEquals("50.0点", lastExam.findElements(By.tagName("td")).get(1).getText());
		...
		FileUtils.copyFile(file,
				new File(
						"evidence/case14/08_examComplete.png"));
	}
